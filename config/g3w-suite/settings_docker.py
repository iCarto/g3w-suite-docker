...
DATABASES = {
    "default": {
        ...
        "USER": os.getenv("G3WSUITE_POSTGRES_USER_LOCAL")
        if os.getenv("G3WSUITE_POSTGRES_USER_LOCAL")
        else "%s@%s"
...
QGIS_AUTH_PASSWORD_FILE = os.getenv(
    "G3WSUITE_QGIS_AUTH_PASSWORD_FILE", "/shared-volume/qgs_dbauth.db"
)
...
TILESTACHE_CACHE_DISK_PATH = os.getenv(
